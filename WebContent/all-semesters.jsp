							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										...
										<a href="addsemester" class="btn btn-primary">+ Add new</a>
									</div>
									<div class="card-body">
										<div class="table-responsive">
											<table id="example3" class="display" style="min-width: 845px">
												...
												<%
													...
													if (semesters != null){
														for(Semester std: semesters){
													
												%>
													<tr>
														<td><strong><%=std.getId()%></strong></td>
														<td><%=std.getName()%></td>
														<td><%=std.getStartDate()%></td>
														<td><%=std.getEndDate()%></td>
														<td>
															<a href="editsemester?id=<%=std.getId()%>" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
															<a href="deletesemester?id=<%=std.getId()%>" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
														</td>												
													</tr>
												<%
														}

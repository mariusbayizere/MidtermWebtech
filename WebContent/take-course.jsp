<%@page import="back.Models.Studentregistration"%>
				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Take</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Take course</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
                            ...
                            <% Studentregistration reg = (Studentregistration) request.getAttribute("registration"); %>
								<h5 class="card-title">Add Course To <%=reg.getStudent().getFirstName() + " " +reg.getStudent().getLastName() %> </h5>
							</div>
							<div class="card-body">
                                <form action="takecourse" method="post">
									<div class="row">
										...
										%>
												<option value="<%=crs.getCourseId()%>"><%=crs.getCoursedefinition().getName() %></option>
											<%
											}
										}
											%>
										...
										<input type="hidden" name="regId" value="<%=reg.getRegistartionId()%>">

...
<%@page import="back.Models.Teacher"%>
				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Assign</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Assign Course</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
                            ...
                            <%
                            	Teacher  tch= (Teacher) request.getAttribute("teacher");
                            %>
								<h5 class="card-title">Assign course To <%=tch.getNames()%> </h5>
							</div>
							<div class="card-body">
                                <form action="assigncourse" method="post">
									<div class="row">
										...
										<%
										List<Coursedefinition> courses = (List<Coursedefinition>) request.getAttribute("courses");
										if (courses != null){
											for(Coursedefinition crs: courses){
												
										%>
												<option value="<%=crs.getCode()%>"><%=crs.getName() %></option>
											<%
											}
										}
											%>
										...
										<input type="hidden" name="teacher" value="<%=tch.getCode()%>">

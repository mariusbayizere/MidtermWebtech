									...
									<div class="card-body">
										<div class="table-responsive">
											<table id="example3" class="display" style="min-width: 845px">
												...
												<tbody>
												<%
													List<Studentregistration> registrations = (List<Studentregistration>) request.getAttribute("registrations");
												...
												%>
													<tr>
														<td><strong><%=reg.getRegistartionId()%></strong></td>
														<td><%=reg.getStudent().getFirstName() +" " +reg.getStudent().getLastName()%></td>
														<td><%=reg.getSemester().getName()%></td>
														<td><%=reg.getRegistrationDate()%></td>
														<td>
															<a href="takecourse?id=<%=reg.getRegistartionId()%>" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
														</td>												
													</tr>
												<%
														}

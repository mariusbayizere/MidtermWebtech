							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										...
										<a href="addteacher" class="btn btn-primary">+ Add new</a>
									</div>
									<div class="card-body">
										<div class="table-responsive">
											<table id="example3" class="display" style="min-width: 845px">
												...
												%>
													<tr>
														<td><strong><%=tch.getCode()%></strong></td>
														<td><%=tch.getNames()%></td>
														<td><%=tch.getQualification()%></td>
														<td>
															<a href="editteacher?id=<%=tch.getCode()%>" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
															<a href="deleteteacher?id=<%=tch.getCode()%>" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
															<a href="assigncourse?id=<%=tch.getCode()%>" class="btn btn-sm btn-primary"><i class="la la-clip-board"></i></a>
														</td>												
													</tr>
												<%
														}

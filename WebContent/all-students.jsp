        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid">
				...
				<form action="DataFilterServlet" method="get">
				<div class="row">
							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										...
										<a href="addstudent" class="btn btn-primary">+ Add new</a>
									</div>
									<div class="card-body">
										<div class="table-responsive">
											<table id="example3" class="display" style="min-width: 845px">
												...
												%>
													<tr>
														<td><strong><%=std.getRegNo()%></strong></td>
														<td><%=std.getFirstName()%></td>
														<td><%=std.getLastName()%></td>
														<td><%=std.getDateOfBirth()%></td>
														<td>
															<a href="editstudent?id=<%=std.getRegNo()%>" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
															<a href="deletestudent?id=<%=std.getRegNo()%>" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
															<a href="registerstudent?id=<%=std.getRegNo()%>" class="btn btn-sm btn-primary"><i class="fa-regular fa-clipboard"></i></a>
														</td>												
													</tr>
												<%
														}

        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid">
				...
				<%
				Semester std = (Semester) request.getAttribute("semester");
				%>
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form action="editsemester" method="post">
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="date" class="form-control" name="startDate" value="<%=std.getStartDate() %>">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">End Date</label>
												<input type="date" class="form-control" name="endDate" value="<%=std.getEndDate() %>">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">

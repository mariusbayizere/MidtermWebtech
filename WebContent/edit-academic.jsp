									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="firstName" value="<%=std.getFirstName() %>">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Last Name</label>
												<input type="text" class="form-control" name="lastName" value="<%=std.getLastName() %>">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Date Of Birth</label>
												<input type="date" class="form-control" name="DOB" value="<%=std.getDateOfBirth() %>">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Roll No.</label>
												<input type="text" class="form-control" name="regNo" value="<%=std.getRegNo() %>">
											</div>
										</div>

									...
									<div class="card-body">
										<div class="table-responsive">
											<table id="example3" class="display" style="min-width: 845px">
												...
												<tbody>
												<%
													List<Coursedefinition> courses = (List<Coursedefinition>) request.getAttribute("courseList");
												...
												%>
													<tr>
														<td><strong><%=crs.getCode()%></strong></td>
														<td><%=crs.getName()%></td>
														<td><%=crs.getDescription()%></td>
														<td>
															<a href="editcourse?id=<%=crs.getCode()%>" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
															<a href="deletecourse?id=<%=crs.getCode()%>" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
														</td>												
													</tr>
												<%
														}
